...
export const en = {
  journey: {
    ...
    modal: {
      ...
      milestonesExplanation: 'With your total distance, you could have...',
      ...
      planetYearsTemplate: '{planet} years',
      planets: {
        Mercury: 'Mercury',
        Venus: 'Venus',
        Earth: 'Earth',
  ...
  share: {
    ...
    shareText:
      'Check out my cosmic journey! Discover yours and see how the solar system looked when you were born!',
    years: 'years',
    months: 'months',
    days: 'days',
    madeWith: 'Made with',
    ...
    tripsToTheMoonAndBack: 'trips to the Moon and back',
    ofALightYear: 'of a light-year',
    frameLabels: {
      spin: 'Spin',
      orbit: 'Orbit',
